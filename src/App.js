...
// // Sample product data
// const products = [
//   { id: 1, name: 'Laptop', category: 'Electronics', description: 'A high-end laptop.', price: 1000, image: 'https://via.placeholder.com/300' },
//   { id: 2, name: 'Smartphone', category: 'Electronics', description: 'Latest smartphone with 5G.', price: 800, image: 'https://via.placeholder.com/300' },
//   { id: 3, name: 'Shoes', category: 'Fashion', description: 'Comfortable running shoes.', price: 60, image: 'https://via.placeholder.com/300' },
//   { id: 4, name: 'Jacket', category: 'Fashion', description: 'Winter jacket.', price: 120, image: 'https://via.placeholder.com/300' },
//   { id: 5, name: 'Blender', category: 'Home Appliances', description: 'Powerful blender.', price: 150, image: 'https://via.placeholder.com/300' },
...
//         <CategoryFilter categories={['Electronics', 'Fashion', 'Home Appliances']} onFilter={handleCategoryChange} />
